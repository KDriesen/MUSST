...
!! version: 1.0
!! brief: LIBVTKIO is a library of functions for Input and Output pure fortran data (both ascii and binary) in VTK format.
!------------------------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------------------------------------------------------------
USE IR_VTK ! Real and integer portable multi-precision kind definition.
!-----------------------------------------------------------------------------------------------------------------------------------
